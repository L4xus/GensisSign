# for windows hence `win`

curl https://files.pythonhosted.org/packages/e5/50/bd3e53910ea5015597b7f456d15ef4e04bf499a1b4929a5aa86df236d413/ --output apk-signer-1.1.1.tar.gz
